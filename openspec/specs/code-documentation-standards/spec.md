...
TBD — capture the codebase's docstring and documentation conventions (module, function, and class
docstring requirements; test-code exemptions; lint enforcement) as further changes land.
